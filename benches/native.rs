...
#[bench]
fn std_hashmap_insert_mut_10(b: &mut Bencher) { std_hashmap_insert_n(10, b) }

#[bench]
fn std_hashmap_insert_mut_100(b: &mut Bencher) { std_hashmap_insert_n(100, b) }
...
#[bench]
fn std_btreemap_insert_10(b: &mut Bencher) { std_btreemap_insert_n(10, b) }

#[bench]
fn std_btreemap_insert_100(b: &mut Bencher) { std_btreemap_insert_n(100, b) }

#[bench]
fn std_btreemap_insert_1000(b: &mut Bencher) { std_btreemap_insert_n(1000, b) }
...
#[bench]
fn vecdeque_push_back_mut_10(b: &mut Bencher) { vecdeque_push_back_mut(b, 10) }
...
#[bench]
fn vecdeque_pop_front_mut_10(b: &mut Bencher) { vecdeque_pop_front_mut(b, 10) }
...
#[bench]
fn vecdeque_pop_back_mut_10(b: &mut Bencher) { vecdeque_pop_back_mut(b, 10) }

#[bench]
fn vecdeque_pop_back_mut_100(b: &mut Bencher) { vecdeque_pop_back_mut(b, 100) }
...
#[bench]
fn vecdeque_split_10(b: &mut Bencher) { vecdeque_split(b, 10) }

#[bench]
fn vecdeque_split_100(b: &mut Bencher) { vecdeque_split(b, 100) }

#[bench]
fn vecdeque_split_1000(b: &mut Bencher) { vecdeque_split(b, 1000) }

#[bench]
fn vecdeque_split_100000(b: &mut Bencher) { vecdeque_split(b, 100_000) }
...
#[bench]
fn vecdeque_append_10(b: &mut Bencher) { vecdeque_append(b, 10) }

#[bench]
fn vecdeque_append_100(b: &mut Bencher) { vecdeque_append(b, 100) }

#[bench]
fn vecdeque_append_1000(b: &mut Bencher) { vecdeque_append(b, 1000) }

#[bench]
fn vecdeque_append_10000(b: &mut Bencher) { vecdeque_append(b, 10_000) }

#[bench]
fn vecdeque_append_100000(b: &mut Bencher) { vecdeque_append(b, 100_000) }
...
#[bench]
fn vec_split_10(b: &mut Bencher) { vec_split(b, 10) }

#[bench]
fn vec_split_100(b: &mut Bencher) { vec_split(b, 100) }

#[bench]
fn vec_split_1000(b: &mut Bencher) { vec_split(b, 1000) }

#[bench]
fn vec_split_100000(b: &mut Bencher) { vec_split(b, 100_000) }
...
#[bench]
fn vec_append_10(b: &mut Bencher) { vec_append(b, 10) }

#[bench]
fn vec_append_100(b: &mut Bencher) { vec_append(b, 100) }

#[bench]
fn vec_append_1000(b: &mut Bencher) { vec_append(b, 1000) }

#[bench]
fn vec_append_10000(b: &mut Bencher) { vec_append(b, 10_000) }

#[bench]
fn vec_append_100000(b: &mut Bencher) { vec_append(b, 100_000) }
...
#[bench]
fn vec_push_back_mut_10(b: &mut Bencher) { vec_push_back_mut(b, 10) }

#[bench]
fn vec_push_back_mut_100(b: &mut Bencher) { vec_push_back_mut(b, 100) }

#[bench]
fn vec_push_back_mut_1000(b: &mut Bencher) { vec_push_back_mut(b, 1000) }

#[bench]
fn vec_push_back_mut_100000(b: &mut Bencher) { vec_push_back_mut(b, 100_000) }
...
#[bench]
fn vec_pop_back_mut_10(b: &mut Bencher) { vec_pop_back_mut(b, 10) }

#[bench]
fn vec_pop_back_mut_100(b: &mut Bencher) { vec_pop_back_mut(b, 100) }

#[bench]
fn vec_pop_back_mut_1000(b: &mut Bencher) { vec_pop_back_mut(b, 1000) }

#[bench]
fn vec_pop_back_mut_100000(b: &mut Bencher) { vec_pop_back_mut(b, 100_000) }
